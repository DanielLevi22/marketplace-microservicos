...
// Spec 07-metricas-http-prometheus.md
describe('MetricsController (e2e)', () => {
  ...
  // Nao-regressao: guard JWT global continua exigindo token nas demais rotas
  it('/ (GET) still returns 401 without an Authorization header', () => {
